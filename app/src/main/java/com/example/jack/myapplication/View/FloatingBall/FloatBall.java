package com.example.jack.myapplication.View.FloatingBall;
...
//        stopClipRunner();
    ...
    private void initScreenParams() {
        mTop = Util.getStatusHeight(getContext());
        mScreenWidth = Util.getScreenWidth(getContext());
        mScreenHeight = Util.getScreenHeight(getContext());
    }
