...
/**
 * 改写别人的一个好看的View来显示花费金钱的多少
 * Created by Liujilong on 2015/12/18.
 * liujilong.me@gmail.com
 */
public class SpendView extends View {
    ...
    public SpendView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SpendView(Context context, AttributeSet attrs, int defStyleAttr) {
